...
import {BackgroundMediaProvider} from '@/app/context/BackgroundMediaContext'
import GlobalBackgroundMedia from '@/app/components/GlobalBackgroundMedia'
      ...
      <body>
        <LenisProvider>
          <BackgroundMediaProvider>
            {/* GLOBAL BACKGROUND: Persistent video layer that never unmounts on navigation.
                Pages call setBackground() to change the video - crossfades smoothly. */}
            <GlobalBackgroundMedia />
